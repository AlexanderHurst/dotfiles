...
globalkeys =
    ...
    awful.key(
        ...
        "Print",
        function()
            awful.spawn.with_shell("sleep 0.1; rm -f ~/temporaryimageforclipboard.png; scrot -u ~/temporaryimageforclipboard.png; xclip -selection c -t image/png ~/temporaryimageforclipboard.png; rm -f ~/temporaryimageforclipboard.png")
        end,
    ...
    awful.key(
        ...
        "Print",
        function()
            awful.spawn.with_shell("sleep 0.1; rm -f ~/temporaryimageforclipboard.png; scrot -s ~/temporaryimageforclipboard.png; xclip -selection c -t image/png ~/temporaryimageforclipboard.png; rm -f ~/temporaryimageforclipboard.png")
        end,
